...
```bash
git clone https://github.com/realandrewren/pennywise.git
cd finance-nanogpt
```
...
- Our team focuses on building a personalized GPT-2 Small (124M) language model using the [**nanoGPT**](https://github.com/karpathy/nanogpt) framework.
